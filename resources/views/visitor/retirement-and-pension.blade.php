...
<div class="slide kenburns" style="background-image:url({{ asset('visitor/img/best-retirement-investment-2136x1427.jpg') }});">
    <div class="bg-overlay"></div>
    <div class="container">
        <div class="slide-captions text-center text-light">

            <span class="strong">{{ env('SITE_NAME_SHORT') }}</span>
            <h1 style="color: #fff !important">Retirement and Pension Fund Investments Package</h1>
...
<div class="container">
    <div class="row align-items-center">
        <div class="col-lg-6"> <img alt="" style="width: 100% !important"
                src="{{ asset('visitor/img/Investment-October.jpg') }}">
        </div>
        <div class="col-lg-6">
...
<div class="container">
    ...
    <div class="tradingview-widget-container">
        ...
        <script type="text/javascript"
            src="../s3.tradingview.com/external-embedding/embed-widget-forex-heat-map.js" async>
        {
            "width": "100%",
            "height": 400,
            "currencies": [
...
section.pricing {
background: #007bff;
background: linear-gradient(to right, #012c6dc2, #012c6d91), url({{ asset('visitor/img/retirement-investment-for-your-portfolio.jpg') }}) no-repeat;
...
<div class="container">
    <div class="heading-text heading-section text-center center-pos">
        <h2 style="color: #fff !important; font-size: 30px !important">RETIREMENT AND PENSION FUND INVESTMENT <span class="in-highlight ttyy">PLANS</span></h2>
    ...
    <div class="row rtyuiy567">
        ...
        <div class="col-lg-3">
            <div class="card mb-5 mb-lg-0">
                <div class="card-body">
                    <h5 class="card-title text-muted text-uppercase text-center">Novice PLAN</h5>
                    <h6 class="card-price text-center">9%<span class="period">/Weekly</span></h6>
                    <hr>
                    <ul>
                        <li><b>Investment</b>: $2,000 - $9,999</li>
                        <li><b>R.O.I</b>: 1.29% Daily</li>
        ...
        <div class="col-lg-3">
            <div class="card mb-5 mb-lg-0">
                <div class="card-body">
                    <h5 class="card-title text-muted text-uppercase text-center">Enthusiast  PLAN</h5>
                    <h6 class="card-price text-center">12%<span class="period">/Weekly</span></h6>
                    <hr>
                    <ul>
                        <li><b>Investment</b>: $10,000 - $24,999
                        </li>
                        <li><b>R.O.I</b>: 1.72% Daily</li>
                        <li><b>Plan Duration</b>: 7 Days</li>
                        <li><b>Referral Bonus</b>: 5%</li>
                        <li><b>24/7 Support</b>: YES</li>
                    </ul>
        ...
        <div class="col-lg-3">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-muted text-uppercase text-center">Enterprise PLAN</h5>
                    <h6 class="card-price text-center">15%<span class="period">/Weekly</span></h6>
                    <hr>
                    <ul>
                        <li><b>Investment</b>: $25,000 - $49,999
                        </li>
                        <li><b>R.O.I</b>: 2.15% Daily</li>
                        <li><b>Plan Duration</b>: 7 Days</li>
        ...
        <div class="col-lg-3">
            <div class="card mb-5 mb-lg-0">
                <div class="card-body">
                    <h5 class="card-title text-muted text-uppercase text-center tup">Legacy  Plan</h5>

...
<body>
    ...
    <!-- Top Scroll End -->
     ...
     <nav class="cd-dropdown d-block d-sm-block d-md-block d-lg-none d-xl-none">
        <h2><a href="index.html"> SiteName </a></h2>
            ...
            <div class="row">
                        ...
                        <div class="counter-section">
                            <div class="ft_about_icon float_left">
                                ...
                                <div class="ft_abt_text_wrapper">
                                    <p class="timer"> <span>62236</span></p>
                                    <p>total member</p>
                                </div>
                            ...
                            <div class="ft_about_icon float_left">
                                ...
                                <div class="ft_abt_text_wrapper">
                                    <p class="timer"><span>27236</span></p>
                                    <p>total deposited</p>
                                </div>
                            </div>
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div class="copyright_wrapper float_left">
                        <div class="copyright">
                            <p>Copyright <i class="far fa-copyright"></i> 2020 <a href="index.html"> SiteName</a>. all right reserved </p>
                        </div>

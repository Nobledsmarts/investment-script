...
<div class="slide kenburns" style="background-image:url({{ asset('visitor/site-images/btc3.jpg') }});">
    <div class="bg-overlay"></div>
    <div class="container">
        <div class="slide-captions text-center text-light">

            <span class="strong">{{ env('SITE_NAME_SHORT') }}</span>
            <h1 style="color: #fff !important">Cryptocurrency Investments Package</h1>
    ...
    <div class="uk-grid">
        <div class="uk-width-1-1">
            <div class="uk-card uk-card-secondary uk-background-center-right uk-background-contain uk-background-image@m"
                style="background-image: url({{ asset('visitor/site-images/1_Dp1RAdoqmPaIXLES-3suHA.jpg') }}); background-size: contain; height: 280px">
                ...
                <div class="uk-card-body">
                    <div class="uk-grid">
                        <div class="uk-width-1-2@m uk-margin-small-left">
                            ...
                            <p class="uk-margin-small-top">{{ env('SITE_NAME_SHORT') }} Investments is an
    ...
    <div class="row">
        <div class="col-lg-12" data-animate="bounceInDown">
            ...
            <p>
                ...
                <br> <br>
                At {{ env('SITE_NAME_SHORT') }}, we believe investors deserve an established, trusted, and
                accountable partner
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="heading-text heading-section text-center m-b-40">
                ...
                <span class="lead center-pos" style="font-size: 16px; display:inline-block"> {{ env('SITE_NAME_SHORT') }} Investments utilizes innovative proprietary technologies to provide
                    managed cryptocurrency trading services to yield higher returns for investors. </span>
            </div>

            <div
                style="background-color: #1D2330; overflow:hidden; box-sizing: border-box; border: 1px solid #56667F; border-radius: 4px; text-align: right; line-height:14px; font-size: 12px; font-feature-settings: normal; text-size-adjust: 100%;padding:1px;padding: 0px; margin: 0px; width: 100%;">
...
<div class="container">
    <div class="row align-items-center">
        <div class="col-lg-6"> <img alt="" style="width: 100% !important"
                src="{{ asset('visitor/img/1605-trading-750x500.jpg.webp') }}"> </div>
        <div class="col-lg-6">
            <div class="heading-text heading-section mt-5">
                ...
                <p style="font-size: 15px; font-weight: 400;margin-bottom: 10px;"> {{ env('SITE_NAME_SHORT') }}                                is solely and passively invested in Bitcoin, enabling investors to gain exposure to BTC
                    in the form of a security while avoiding the challenges of buying, storing, and
                    safekeeping BTC directly.

                    <br><br>
                    {{ env('SITE_NAME_SHORT') }}’s assets are stored in offline or “cold” storage with Coinbase
                ...
                <a class="btn" href="secured/auth/create-new-account.html"><i class="fa fa-user"></i> Open
                    an account</a>
            </div>
        </div>
    </div>
...
<section style="padding: 30px" class="hide-on-mobile">
<div class="container">
    <div class="tradingview-widget-container" style="width: 100% !important">
        <div class="tradingview-widget-container__widget"></div>

        <script type="text/javascript"
            src="../s3.tradingview.com/external-embedding/embed-widget-screener.js" async>
        {
            "width": "100%",
            "height": "450",
...
section.pricing {
background: #007bff;
background: linear-gradient(to right, #012c6dc2, #012c6d91), url({{ asset('visitor/site-images/btc3.jpg') }}) no-repeat;

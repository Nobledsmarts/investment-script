...
<div class="slide kenburns" style="background-image:url({{ asset('visitor/site-images/image-8.jpg') }});">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <p class="text-center">{{ env('SITE_NAME_SHORT') }}</p>

            <div class="text-container">
                <p> Strategy matters. {{ env('SITE_NAME_SHORT') }}'s approach to managing investments on behalf
                    of our clients is
                ...
                <br>
                <h4 class="page__main__title text-center uppercase"
                    style="text-transform: uppercase; text-align: center; font-size: 25px"><b>So how does it
                        work?</b></h4>
                <br>
                <h3 class="page__main__title">Promote
                    {{ env('SITE_NAME_SHORT') }} Investmets</h3>
                <p>
                ...
                <p>
                    ...
                    referral. Tier two is a 2% reward for every person that signs up under your referral
                    becoming their referral. We even offer a tier three reward of 1% for every referral that
                    signs up under your referrals referral.
                    Our goal is to reward you every step of the way and help you grow your wealth. There is
                    no cap or end to those rewards for as long as any referral in any tier stays active and
                    stays invested.
...
<div class="uk-container">
    <div class="uk-grid">
        ...
        url({{ asset('visitor/site-images/trading-desk-1536x1024.jpg') }})">
                <div class="uk-card-body">
                    <div class="uk-grid uk-flex-middle">
                        <div class="uk-width-2-4@m">
                            ...
                            <h2 class="uk-margin-remove-bottom hhwj6738 center-pos"
                                style="color: #fff !important; font-size: 20px !important;">{{ env('SITE_NAME_SHORT') }}                                            Elite Affiliate Program</h2>
                            ...
                            </p> <a class="uk-button uk-button-primary uk-button-large uk-border-rounded"
                                href="#">Open
                                an Account</a>
                        </div>
                    </div>

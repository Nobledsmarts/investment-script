...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <p><strong>SilverCapitalTrade</strong> wants to verify that you are the owner of this email before your password can be reset.</p>
        <p>
        ...
        <p>
            You can now reset your SCT password.

          ...
          <tr> 
           <td class="m_-5121672750293699009content-shell" align="center"> 
            ...
            <table align="left" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing:0"> 
             <tbody>
              <tr> 
               <td class="m_-5121672750293699009gem-copy m_-5121672750293699009content-padding m_-5121672750293699009gem-p" align="left" style="padding-top:20px;color:#221f1f;padding-left:40px;padding-right:40px;font-family:NetflixSans-Light,Helvetica,Roboto,Segoe UI,sans-serif;font-weight:300;font-size:16px;line-height:21px;font-size:16px;line-height:21px"> You can start your investment journey after you finnish verifying your account with us, it is very important to us that your account is verified, so that we can be able to detect fake accounts.</td> 
              </tr> 
             </tbody>
            </table> 
            <table align="left" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing:0"> 
             <tbody>
              <tr> 
               <td class="m_-5121672750293699009gem-copy m_-5121672750293699009content-padding m_-5121672750293699009gem-p" align="left" style="padding-top:20px;color:#221f1f;padding-left:40px;padding-right:40px;font-family:NetflixSans-Light,Helvetica,Roboto,Segoe UI,sans-serif;font-weight:300;font-size:16px;line-height:21px;font-size:16px;line-height:21px"> Once verified, it’ll be used to make deposit and withdrawal </td> 
              </tr> 
             </tbody>
            </table> 
              ...
              <tr> 
               <td class="m_-5121672750293699009gem-single-button m_-5121672750293699009content-padding" style="padding-top:20px;padding-left:40px;padding-right:40px" align="center"> 
                <table class="m_-5121672750293699009gem-single-button m_-5121672750293699009button-1-table" cellpadding="0" cellspacing="0" border="0" style="border-spacing:0;width:100%"> 
                 <tbody>
                  <tr> 
                   <td class="m_-5121672750293699009gem-single-button m_-5121672750293699009button-1-text m_-5121672750293699009gem-h5 m_-5121672750293699009button-text-light" style="background-color:#e50914;border:solid 1px #e50914;font-family:NetflixSans-Bold,Helvetica,Roboto,Segoe UI,sans-serif;font-weight:700;color:rgb(255,255,255);border-radius:4px;text-decoration:none;text-align:center;padding:13px 0 13px 0;width:100%;font-size:14px;line-height:17px;letter-spacing:-0.2px"> <a class="m_-5121672750293699009gem-single-button m_-5121672750293699009button-text-light m_-5121672750293699009gem-h5" href="{{env('SITE_LINK')}}/user/account/verification?token={{ $details['token']}}&email={{ $details['email'] }}" style="text-decoration:none;display:block;padding-left:20px;padding-right:20px;font-family:NetflixSans-Bold,Helvetica,Roboto,Segoe UI,sans-serif;font-weight:700;color:inherit;color:rgb(255,255,255);font-size:14px;line-height:17px;letter-spacing:-0.2px" target="_blank">VERIFY ACCOUNT</a> </td> 
                  </tr> 
                 </tbody>
                </table> </td> 
              </tr> 
            ...
            <table align="left" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing:0"> 
             <tbody>
              <tr> 
               <td class="m_-5121672750293699009gem-copy m_-5121672750293699009content-padding m_-5121672750293699009gem-p" align="left" style="padding-top:20px;color:#221f1f;padding-left:40px;padding-right:40px;font-family:NetflixSans-Light,Helvetica,Roboto,Segoe UI,sans-serif;font-weight:300;font-size:16px;line-height:21px;font-size:16px;line-height:21px"> We're here to help if you need it. Visit the <a href="{{env('SITE_LINK')}}/help" style="text-decoration:underline;color:inherit" target="_blank">Help Center</a> for more info or <a href="{{env('SITE_LINK')}}/contact-us" style="text-decoration:underline;color:inherit" target="_blank">contact us</a>. </td> 
              </tr> 
             </tbody>
            </table> 
            <table align="left" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing:0"> 
                   ...
                   <td> 
                    <table width="100%" valign="top" cellpadding="0" cellspacing="0" border="0" style="border-spacing:0"> 
                     <tbody>
                      ...
                      <tr> 
                       <td class="m_-5121672750293699009gem-legal" style="font-size:11px;line-height:14px;letter-spacing:-0.1px;font-family:NetflixSans-Light,Helvetica,Roboto,Segoe UI,sans-serif;font-weight:300;color:rgb(164,164,164)"> This message was mailed to <span class="m_-5121672750293699009hide-link" style="text-decoration:none;color:rgb(164,164,164)"><a href="#" style="text-decoration:none;text-decoration:underline;color:rgb(164,164,164);color:inherit" target="_blank">[{{ $details['email'] }}]</a></span> by {{env('SITE_NAME')}} as part of your {{env('SITE_NAME')}}&nbsp;membership.<br> </td> 
                      </tr> 
                     </tbody>
                    </table> </td> 
                  </tr> 

...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <a href="https://www.silvercapitaltrade.com" target="_blank" >
         ...
         <p>Thank you for choosing <strong>SilverCapitalTrade</strong> to start your investment journey.</p>
        <p>
         Your SCT ID is: <span style="color:red;font-weight:bold">{{ ucfirst($details['uid']) }}</span>.
         <br>
         Your SCT Username is: <span style="color:red;font-weight:bold">{{ ucfirst($details['username']) }}</span>.
         <br>
         Please click the link below to verify your account with <span style="color:red;font-weight:bold">SilverCapitalTrade</span> SCT platform.</p>
        ...
        <div style="padding:0px 0px 25px 0px; display: none">
         ...
         <br><br>
         To start investing with SCT, you must have an account, to secure an account four yourself is very simple, in just a few minutes. <br>
         </td>
         </tr>
         </tbody></table>
        </div>
        
        <a href="https://silvercapitaltrade.com/register" style="color:#ffffff;text-decoration:none; display: none" target="_blank" >
        ...
        <div style="padding:25px 0px 25px 0px">
         ...
         <br><br>
            ...
            <!-- <a href="https://www.silvercapitaltrade.com/platforms" style="color:#f00" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://www.silvercapitaltrade.com/platforms&amp;source=gmail&amp;ust=1629257826760000&amp;usg=AFQjCNGICyUGuPZdfvIbYoHen-evQqlPYw">
                trading platforms
            </a>  -->
        ...
        <a  href="https://silvercapitaltrade.com/user/account/verification?token={{ $details['token']}}&email={{ $details['email'] }}" style="color:#ffffff;text-decoration:none" target="_blank">
            <div align="center" style="width:400px;background-color:#d50002;border-radius:5px;text-align:center;padding:10px 20px;color:#ffffff;font-size:16px;font-weight:bold;margin:auto">

...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <p>Oops!  <strong>SilverCapitalTrade</strong> has denied your {{ $details['reinvestment'] ? 'reinvestment' : 'deposit' }} request, please reachout to our team if you think this might be an error.</p>
